...
- The "Ask your agent about this" section (`#agents`) is a native `<details>` that starts closed with a rotating caret; keep the download, prompt, copy, examples and companion inside it. Change either rule only when Ethan changes direction.
