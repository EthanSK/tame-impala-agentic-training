...
- Read BIBLE.md and COVERAGE.md, then follow claim IDs into data/reference.json and the source records.
...
- Edit data/external.json or data/session-sources.json for research claims, then run python3 scripts/build.py and python3 scripts/check.py. The unified JSON, source presentation, BIBLE.md, GEAR.md and site HTML are generated.
