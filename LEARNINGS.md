...
- Hero framing must stay close and cropped: Ethan rejected both blank space above a small bottom-anchored head and fitting the entire long illustration into a normal desktop screen. Bound hero height separately from portrait width, enlarge the desktop figure, and crop its lower body; taller mobile layouts reveal more of the abstract body without stretching the face.
